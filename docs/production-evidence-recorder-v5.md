# Production Evidence Recorder v5

## Contract

Every evaluation is written as an immutable, compressed packet under schema
`production_decision_evidence_v5`. The packet contains:
...
and deletes. The v5 coverage columns separately report decision provenance, raw
