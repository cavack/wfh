# Production Evidence Recorder v7

## Contract

Every evaluation is written as an immutable, compressed packet under schema
`production_decision_evidence_v7`. The packet contains:
...
- every order-book level actually consumed by production depth and churn;
