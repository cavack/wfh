...
Stack base: certified Wave 1B2 head `791be6805bb1b83a60c17b3ee0e6ce9010e4ce40`
Design baseline `main`: `652f99446ed523c0a602798dde4457bab7983373`
...
Current ScoreV2 version is `score_v2`.
...
`score_version` is taken from the deterministic scoring producer and for the current pipeline is `score_v2`.
...
- experimental eligibility emits `EXPERIMENTAL / experimental_pretrigger_v1`;
- strict eligibility emits `STRICT / strict_score_v2`;
