  ...
  return (
    <main className="min-h-screen bg-slate-950 px-4 py-6 text-slate-100 sm:px-6 lg:px-10">
      ...
      <section id="live-candidates" className="mx-auto mb-5 max-w-7xl scroll-mt-4">
        {rows.length > 0 && <p className="mb-3 text-xs text-slate-500">Complete Score V2 candidates keep their existing score. Partial Watch Score ordering uses normalized score × evidence coverage; missing coverage remains unavailable. The Top 3 panel is observational and does not alter state or eligibility.</p>}
        {emptyState}
      </section>
